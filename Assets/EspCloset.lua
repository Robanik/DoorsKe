...
local function createHighlight(object)
    ...
    highlight.Name = "ClosetHighlight"
    ...
    for _, room in pairs(currentRooms:GetChildren()) do
        for _, descendant in pairs(room:GetDescendants()) do
            if descendant:IsA("Model") then
                ...
                if name:find("wardrobe") or name:find("closet") or name:find("cabinet") or 
                   name == "locker" or name:find("hiding") then
            ...
            if descendant:IsA("BasePart") then
                ...
                if name == "door" then
                    ...
                    if parent and parent:IsA("Model") then
                        ...
                        if parentName:find("wardrobe") or parentName:find("closet") or 
                           parentName:find("cabinet") or parentName:find("locker") then
                            
                            local hasESP = false
                            for obj, _ in pairs(ESPObjects) do
                                if obj and obj.Parent and obj.Parent == parent then
                                    hasESP = true
                                    break
                                end
                            end
